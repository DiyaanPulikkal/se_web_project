            ...
            <div>
                <div id = "Queensland" className={style.imageContainPicQueensland}>
                    ...
                    <div className={style.textOverQueenslandPic}>
                        <h6>The University of <br />Queensland</h6>
                        <p>KMITL-Queensland Double-Degree Program <br /> in Software Engineering</p>
                    </div>
                ...
                <div className={style.divOfReqandFeeandIma}>
                    <div className={style.divContainImageQueeensland}>
                        <img src={queensland_stu} alt="Students of Queensland" className={style.imagestudent_Queensland} />
            ...
            <div>
                <div id = "KMITL" className={style.imageContainPickmitl}>
                    ...
                    <div className={style.textOverkmitlPic}>
                        <h6>King Mongkut's Institute <br /> of Technology Ladkrabang</h6>
                ...
                <div className={style.divAroundimage_Year1_2}>
                    <div className={style.divAroundimageinsertBesideyear1_2}>
                        <img src={se_software_insert} alt="Software Engineering" className={style.imageinsertBesideyear1_2} />
                    </div>
                ...
                <div className={style.divOfReqandFeeandIma}>
                    ...
                    <div className={style.divRequirmentNFee}>
                        <div className={style.divRequirment}>
                            ...
                            <ol>
                                ...
                                <li>Artificial Intelligence - Specializing in applications of artificial intelligence and data science, including machine learning and Big Data.</li>
                            </ol>
                            <p>
                    ...
                    <div className={style.linkExploreMorediv}>  
                        <p>For more information: <a href="https://www.kmitl.ac.th" target="_blank">visit KMITL website here</a></p>
                    </div>
                </div>
            </div>
