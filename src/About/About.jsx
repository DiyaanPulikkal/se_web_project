...
function About(){
    ...
    return(
        ...
        <div className= {style.backgroundAreaEachbox24}>
            <h1 className= {style.topicName}>Why study Software Engineer?</h1>
            <div className={style.textExplainArea}>
        ...
        <div className= {style.backgroundAreaEachbox1and3}>
            <h1 className= {style.topicName}>Why KMITL?</h1>
            <div className={style.textExplainArea}>
                <p>&nbsp;&nbsp;&nbsp;&nbsp;KMITL's Software Engineering program stands out for its strong technical foundation, practical learning approach, and industry connections. Known as one of Thailand's top engineering institutes, KMITL offers a well-rounded curriculum covering core areas of software development and emerging fields like AI and cybersecurity. Students benefit from modern labs, industry-sponsored projects, and internship opportunities, all of which provide real-world experience. With international partnerships, a vibrant student community, and a focus on innovation, KMITL fosters an environment conducive to both academic excellence and career readiness, making it a competitive choice for aspiring software engineers</p>
            </div>
        </div>

        <div className= {style.backgroundAreaEachbox24}>
            <h1 className= {style.topicName}>Careers in Software Engineering</h1>
            <div className={style.textExplainArea}>
                ...
                <p>With strong foundation in computer science, mathematics, and software engineering principles, graduates of the SE program may continue their studies at postgraduate level in various software engineering or computing related fields in universities worldwide.</p>
            </div>
        </div>
