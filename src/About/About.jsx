...
function About(){
    ...
    const content2 = <p>It is hard to overstate the ubiquity of software nowadays. Every computer system is governed by software. 
                        ...
                        software engineering that students obtained from traditional computer science and computer engineering 
                        curriculums are insufficient. The development of real-world software applications requires the skills in 
                        analysing the problem domain and the customer's requirement and the skills in designing the software from 
    ...
    const content3 = <p>KMITL's Software Engineering program stands out for its strong technical foundation, practical learning approach, 
                        ...
                        real-world experience. With international partnerships, a vibrant student community, and a focus on innovation, 
                        KMITL fosters an environment conducive to both academic excellence and career readiness, making it a competitive 
                        choice for aspiring software engineers.</p>;
    ...
    const content4 = <>
                        ...
                        <ul>
                            <li>Software engineers, software architects, and software developers on various platforms, 
                                including enterprise software, web applications, mobile applications, games, embedded applications, 
                                etc.
                            </li>
