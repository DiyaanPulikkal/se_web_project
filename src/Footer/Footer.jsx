    ...
    <footer className={style.mainFooter}>
      ...
      <div className={style.container}>
        <div className={style.footerLeft}>
          ...
          <br />
          <img className={style.icons} src={phoneIcon} alt="phone" /> 02-329-8000
          <br />
          <br /> 
          <img className={style.icons} src={emailIcon} alt="email" /> siie@kmitl.ac.th
        </div>
        <div className={style.footerRight}>
          ...
          <div>
            <h3>&nbsp;</h3>
            <Link to="/activities">Admission</Link><br />
